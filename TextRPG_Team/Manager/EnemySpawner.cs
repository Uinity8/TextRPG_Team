...
namespace TextRPG_Team.Manager
{
    public class EnemySpawner
    {
        ...
        {
            baseEnemies.Add(new Enemy("미니언", new Stats(15, 5, 0, 2))); // Lv 2
            baseEnemies.Add(new Enemy("공허충", new Stats(10, 9, 0, 3))); // Lv 3
            baseEnemies.Add(new Enemy("대포미니언", new Stats(25, 8, 0, 5))); // Lv 5
        }
        ...
        public void AddRandomEnemies()
        {
            ...
            for (int i = 0; i < randomEnemyCount; i++)
            {
                ...
                // 새 객체로 적을 생성 (복제)
                var newEnemy = new Enemy(randomEnemy.Name, randomEnemy.GetStats);
