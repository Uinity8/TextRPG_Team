...
public class GameState
{
    ...
    public readonly List<Item> _itemList = new List<Item>()
    {
        ...
        new Item("책가방", ItemType.Cursed, new Stats(0, -10, 30), "매우 크고 무겁다. 등에 매면 거북이처럼 변할 수 있을거 같다. ", 2300, 3),
        new Item("수상한 텀블러", ItemType.Cursed, new Stats(0, 15, -10), "누군가의 각성제로 쓰이는거 같다. 이 냄새는 알코올 ? ", 800, 4),
