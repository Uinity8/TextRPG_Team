...
public class GameState
{
    ...
    // {
    //     new Item(1,"노트북", ItemType.Weapon, new Stats(0, 20, 0), "보기보다 가벼운게 아마도 L* gr*m 인거 같다. ", 2800),
    //     new Item(2,"수특책", ItemType.Weapon, new Stats(0, 15, 0), "앞표지만 너덜거린다. 올해 수능이 며칠 남은거지 ? ", 1700),
    //     new Item(3,"책가방", ItemType.Cursed, new Stats(0, -10, 30), "매우 크고 무겁다. 등에 매면 거북이처럼 변할 수 있을거 같다. ", 2300),
    //     new Item(4,"수상한 텀블러", ItemType.Cursed, new Stats(0, 15, -10), "누군가의 각성제로 쓰이는거 같다. 이 냄새는 알코올 ? ", 800),
    //     new Item(5,"회사 다이어리", ItemType.Weapon, new Stats(0, 10, 0), "00회사 창립 00주년 이라 적혀있다. 펼쳐보니 이곳 저곳 욕이 적혀있다. ", 1500),
    // };
